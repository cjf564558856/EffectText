...
vec3 blendFunc(vec3 base,vec3 blend,float opacity)  //opacity sucaidebutoumingdu
{
    vec3 resultColor=BLEND(base,blend,BLEND_MODE);//diejiamoshitihuan
...
void main(void)
{
    ...
    lowp vec4 resultColor1=blendColor(_BgMainTex,resultColor,baseTextureSize,fullBlendTexSize,
    fullBlendAnchor,scale);
    
    gl_FragColor=resultColor1;
}
